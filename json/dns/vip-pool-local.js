module.exports ={
	...
	"paths": {
		...
		"/api/ad/v3/dns/vip-pool/local/{name}": {
			"description": "虚拟IP池配置相关操作",
			"parameters": [
				{
					"$ref": "/api/{common}.yaml#/parameters/token"
		...
		"/api/ad/v3/dns/vip-pool/local/{vip_pool_name}/vips/": {
		...
		"/api/ad/v3/dns/vip-pool/local/{vip_pool_name}/vips/{vip}": {
			"description": "虚拟IP池中的虚拟IP配置相关操作",
			"parameters": [
				{
					"$ref": "/api/{common}.yaml#/parameters/token"
